        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, memcache_service_1.checkMemcachedClient(config)];
                case 1:
                    check = _a.sent();
                    return [2 /*return*/, {
                            name: config.name,
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, web_service_1.checkWebIntegration(config)];
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, {
                            name: config.name,
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    start = new Date().getTime();
                    config.timeout = config.timeout || types_1.Defaults.WebTimeout;
                    return [4 /*yield*/, dynamodb_service_1.checkDynamodbClient(config)];
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, {
                            name: config.name,
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    start = new Date().getTime();
                    config.timeout = config.timeout || types_1.Defaults.WebTimeout;
                    return [4 /*yield*/, database_service_1.checkDatabaseClient(config)];
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, {
                            name: config.name,
